...
<div class="layout">
	...
	<label class="label">Название</label><input type="text" name="array_value" value="{if isset($array.POST.array_value)}{$array.POST.array_value}{else}{$array.moduleCatalogObjectPropertieArray.array_value}{/if}"{if isset($array.errors.array_value_error)} class="error"{/if} />
